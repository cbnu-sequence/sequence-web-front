  ...
  return (
    <>
      <ManagerBlock>
        ...
        <div className="cardblock">
          {[
            { _id: 'leechanhyuk', user: { name: '이찬혁' }, img: '/chan.jpeg', description: '안녕하세요. 시퀀스 백엔드 담당하는 이찬혁입니다.' },
        ...
        <div className="cardblock">
          {[
            { _id: 'kimminkyu', user: { name: '김민규' }, img: '/mk.png' , description: '🍒안녕하세요! 시퀀스 최고 귀염둥이 김민규입니다~🍒},
